...
// Local
router.get('register', '/register', authMdw.guestIn(), function * (next) {
...
// Steam
router.get('steam', '/auth/steam', authMdw.loggedIn(), steamStrategy.login);
router.get('/auth/steam/callback', authMdw.loggedIn(), steamStrategy.callback);
router.get('steam.connect', '/auth//steam/connect', authMdw.loggedIn(), steamStrategy.connect);
router.get('/auth/steam/connect/callback', authMdw.loggedIn(), steamStrategy.connectCallback);

router.get('steam.disconnect', '/auth/steam/disconnect', authMdw.loggedIn(), steamStrategy.disconnect());
